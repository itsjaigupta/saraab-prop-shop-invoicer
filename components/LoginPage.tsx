...
const PASSWORD = '2526';
const INTERNAL_USER = 'itsjaigupta';
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-xs">
        ...
        <div className="bg-[#111] border border-gray-800 rounded-2xl p-8">
          <h2 className="text-white text-lg font-semibold mb-1">Enter Password</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-white text-black font-bold text-[11px] uppercase tracking-widest py-3.5 rounded-lg hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
